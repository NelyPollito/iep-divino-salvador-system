<x-layouts.admin-layout title="Desactivar Semestre">
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card" style="min-height:485px">
                <div class="card-header card-header-text">
                    ...
                    <p class="text-muted">Vas a desactivar: <strong>{{ $semester->semester_name }}</strong></p>
                </div>

                <div class="card-content table-responsive">
                    <form action="{{ route('semesters.destroy', $semester->idsemester) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        
                        <div class="alert alert-danger">
                            <i class="material-icons" style="vertical-align: middle;">warning</i>
                            Esta acción marcará el semestre como <strong>Inactivo</strong>.
                        </div>
