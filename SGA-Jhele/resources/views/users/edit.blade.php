<x-layouts.admin-layout title="Actualizar Usuario">
            ...
            <div class="card" style="min-height:485px">
                ...
                <div class="card-content table-responsive">
                    ...
                    <form action="{{ route('users.update', $user->iduser) }}" method="POST" autocomplete="off">
                        @csrf
                        @method('PUT') {{-- Importante para Laravel en actualizaciones --}}
                                        ...
                                        @if($user->locked_until && \Carbon\Carbon::now()->lt($user->locked_until))
                                            ...
                                            <div class="form-check form-switch">
                                                <input 
                                                    ...
                                                    name="unlock_user" 
                                                    value="1">
                                                <label class="form-check-label fw-semibold" for="unlock_user">
                                                    Desbloquear usuario
                                                </label>
                                            </div>
                                        ...
                                        @else
                                            ...
                                            <div class="text-center py-3">
                                                ...
                                                <p class="text-muted small mt-2 mb-0">
                                                    El usuario puede iniciar sesión sin restricciones
                                                </p>
                                            </div>
