<x-layouts.admin-layout title="Información del Alumno">
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card" style="min-height:485px">
                ...
                <div class="card-content table-responsive">
                    ...
                    <hr>
                    <div class="form-group">
                        <a class="btn btn-primary text-white" href="{{ route('students.index') }}">Regresar a la lista</a>
                        <a class="btn btn-warning text-white" href="{{ route('students.edit', $student->idstudent) }}">Editar este perfil</a>
                    </div>
                </div>
            </div>
        </div>
