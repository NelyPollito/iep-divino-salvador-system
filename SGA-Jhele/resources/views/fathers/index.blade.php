<x-layouts.admin-layout title="Lista de Padres">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($father->user->status == '0')
                                                ...
                                                <a href="#" class="btn btn-secondary text-white" data-toggle="tooltip" title="Hijos">
                                            ...
                                            @else
                                                <a href="#" class="btn btn-warning text-white"><i class='material-icons'>warning</i></a>
                                            @endif
...
{{-- Scripts específicos para DataTables --}}
@push('scripts')
